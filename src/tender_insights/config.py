...
class InsightsConfig:
    ...
    template_whole_doc_max_chars: int = 6000
    template_shard_max_chars: int = 6000
    ...
    def from_env(cls) -> InsightsConfig:
        ...
        return cls(
            ...
            template_whole_doc_max_chars=_env_int("TEMPLATE_WHOLE_DOC_MAX_CHARS", 6000),
            template_shard_max_chars=_env_int("TEMPLATE_SHARD_MAX_CHARS", 6000),
